...
export const authAPI = {
  // Login - calls the Spring Boot backend /api/auth/login endpoint
  login: (credentials) => api.post('/api/auth/login', credentials),
  
  // Register/Signup
  signup: (userData) => api.post('/mobile/health-worker/register', userData),
...
export const motherAPI = {
  // Get all mothers
  getAllMothers: (params) => api.get('/mobile/mothers', { params }),
